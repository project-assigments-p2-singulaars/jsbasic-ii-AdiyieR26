...
if ((pet === "perro") || (pet === 'gato') || (pet === 'pajaro')) {
    ...
    console.logo('No tengo una mascota convencional');
}
...
if ((typeof value ==='number') || (typeof value === 'string')) {
    ...
    console.log('No es mi numero ni string');
}
...
//Escribe tu código aquí
for (const dev in programmers) {
    console.log(`${dev}: ${programmers[dev].name} ${programmers[dev].lastname}, su aporte fue ${programmers[dev].knowledge}`)
}
...
//Escribe tu código aquí
let saludar = (nombre) => `Hola ${nombre}, que tal el dia?`;
console.log(saludar('Adi'));
console.log(saludar('Oleg'));
console.log(saludar('Yumana'));
...
//Escribe tu código aquí
let calcularAreaRectangulo = (ancho, alto) => ancho * alto;
console.log(calcularAreaRectangulo(40, 100));
console.log(calcularAreaRectangulo(60, 200));
console.log(calcularAreaRectangulo(80, 150));
